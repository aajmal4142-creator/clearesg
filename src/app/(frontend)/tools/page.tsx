  ...
  return (
    <div className="flex min-h-full flex-col bg-ink text-bone">
      ...
      <main className="mx-auto max-w-3xl flex-1 px-6 py-16">
        <h1 className="font-display text-[48px] text-bone">Tools</h1>
        ...
        <ul className="mt-10 space-y-4">
          {TOOLS.map((t) => (
            <li key={t.slug} className="border border-graphite p-4">
              <Link href={`/tools/${t.slug}`} className="text-bone hover:underline">
                {t.name}
              </Link>
