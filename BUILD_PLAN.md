...
**As of 2026-07-21:** phases 0–14 are marked complete for **surface delivery** (routes, collections, calc, marketing shell). The items below are **not** fully re-audited across every `/app` surface — treat them as ongoing gates for §12 remaining work.
...
| 8 — Materiality     | [x]    | ESRS topics E1–E5/S1–S4/G1; impact+financial; drag matrix; narrative + audit; `/app/materiality`.                                                                                                                                                                                                                                     |
...
| 10 — Consultant CC  | [x]    | Client table by deadline risk; bulk nudge/export; sector templates; white-label BrandVars; `/app/consultant` + APIs. **Needs end-to-end QA** (logo/colours on `/s`, `/r`, PDF).                                                                                                                                                       |
| 11 — Benchmarking   | [x]    | Percentiles + **n≥8** hard gate; recompute API; demo cohort when empty; `/app/benchmarks`. **No scheduled cron** wired — recompute is on-demand only.                                                                                                                                                                                 |
